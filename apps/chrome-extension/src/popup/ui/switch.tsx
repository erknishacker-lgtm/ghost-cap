...
>(({ className, ...props }, ref) => (
	<SwitchPrimitives.Root
		className={classNames(
			...
			"w-11 h-6 p-0.5",
			"bg-gray-5 data-[state=checked]:bg-gray-12",
			"focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-12",
